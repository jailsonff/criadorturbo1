...
import { Loader2, Zap, LogIn, Lock, Calendar, FileText } from "lucide-react";
...
const Privacy = () => {
            ...
            <div class="mb-8 group">
              <div class="flex items-start gap-4 mb-3">
                <div class="w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center shrink-0 group-hover:bg-emerald-500/20 transition-colors">
                  <span class="text-lg font-bold text-emerald-400">${sectionIndex}</span>
                </div>
  ...
  // Fallback content if no privacy in database
  if (!privacy) {
    return (
      <div className="min-h-screen bg-background">
        <Header />
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <div className="pt-24 pb-8 border-b border-border/50 bg-gradient-to-b from-emerald-500/5 to-transparent">
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="flex items-center justify-center gap-2 text-muted-foreground">
            ...
            <span className="text-sm">
              Última atualização: {new Date(privacy.updated_at).toLocaleDateString("pt-BR", {
                year: "numeric",
                month: "long",
                day: "numeric",
              })}
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        <div className="bg-card/50 backdrop-blur-sm rounded-2xl border border-border/50 p-6 md:p-10 shadow-lg">
          <div
            ...
            dangerouslySetInnerHTML={{ __html: renderMarkdown(privacy.content) }}
          />
        </div>
